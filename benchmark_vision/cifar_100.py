...
if __name__ == "__main__":
    ...
    cifar_train_images, cifar_val_images, cifar_train_labels, cifar_val_labels = train_test_split(cifar_train_images, cifar_train_labels, test_size=0.4)
    
    # validation data further split (train: 300000; val: 150000; test_concat: 50000)
    cifar_val_images, cifar_test_images_concat, cifar_val_labels, cifar_test_labels_concat = train_test_split(cifar_val_images, cifar_val_labels, test_size=0.25)
