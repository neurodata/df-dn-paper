...
if __name__ == "__main__":
    ...
    svhn_train_images, svhn_val_images, svhn_train_labels, svhn_val_labels = train_test_split(svhn_train_images, svhn_train_labels, test_size=0.5)
    
    # validation data further split (train: 50%; val: 25%; test: 25%)
    svhn_val_images, svhn_test_images, svhn_val_labels, svhn_test_labels = train_test_split(svhn_val_images, svhn_val_labels, test_size=0.5)
