# -*- coding: utf-8 -*-
"""
Created on Sun Oct 17 15:18:57 2021
...
len_samp_size = dictionary_params['len_samp_size']
...
train_test_times = {metric:
    {model_name:np.zeros((len_samp_size * len(dataset_indices), shape_2_evolution)) for model_name in best_params_dict.keys()} for metric in ['train','test']}
    ...
    for train_index, test_index in kf.split(X, y):
        ...
        for sample_size_index, max_sample_size in enumerate(training_sample_sizes):
            ...
            for model_name in best_params_dict.keys():
                ...
                if train_test_times['train'][model_name].get(sample_size_index)==None:
                    train_test_times['train'][model_name]
                train_test_times['train'][model_name][sample_size_index] + len_samp_size * dataset_index][k_index] = train_time
                train_test_times['test'][model_name][sample_size_index] + len_samp_size * dataset_index][k_index] = test_time
