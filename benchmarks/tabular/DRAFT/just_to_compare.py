...
def addi(total_len_sizes_and_data =total_len_sizes_and_data , path1 = 'results/cc18_rf_kappa', path2 = 'metrics/cc18_sample_sizes_new',name_model = 'RF',name_metric = 'cohen_kappa'):
...
dict_to_store = addi(total_len_sizes_and_data =total_len_sizes_and_data , path1 = 'results/cc18_rf_kappa', path2 = 'metrics/cc18_sample_sizes_new',name_model = 'RF',name_metric = 'cohen_kappa')
new_dict['cohen_kappa']['RF'] = dict_to_store;

dict_to_store = addi(total_len_sizes_and_data =total_len_sizes_and_data , path1 = 'results/cc18_dn_kappa', path2 = 'metrics/cc18_sample_sizes_new',name_model = 'RF',name_metric = 'cohen_kappa')
new_dict['cohen_kappa']['DN'] = dict_to_store;

dict_to_store = addi(total_len_sizes_and_data =total_len_sizes_and_data , path1 = 'results/cc18_rf_ece', path2 = 'metrics/cc18_sample_sizes_new',name_model = 'RF',name_metric = 'cohen_kappa')
new_dict['ece']['RF'] = dict_to_store;

dict_to_store = addi(total_len_sizes_and_data =total_len_sizes_and_data , path1 = 'results/cc18_dn_ece', path2 = 'metrics/cc18_sample_sizes_new',name_model = 'RF',name_metric = 'cohen_kappa')
