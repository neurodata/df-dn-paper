...
def main():
    ...
    classes_space = list(combinations(nums, 8))
    ...
    write_result("8_class/naive_rf.txt", naive_rf_acc_vs_n)
    ...
    write_result("8_class/cnn32.txt", cnn32_acc_vs_n)
    ...
    write_result("8_class/cnn32_5l.txt", cnn32_5l_acc_vs_n)
    ...
    write_result("8_class/resnet18.txt", resnet18_acc_vs_n)

    # naive_rf_acc_vs_n = load_result("8_class/naive_rf.txt")
    # cnn32_acc_vs_n = load_result("8_class/cnn32.txt")
    # cnn32_2l_acc_vs_n = load_result("8_class/cnn32_2l.txt")
    # cnn32_5l_acc_vs_n = load_result("8_class/cnn32_5l.txt")
    # resnet18_acc_vs_n = load_result("8_class/resnet18.txt")
    ...
    plt.legend()
    plt.savefig("8_class/8_classes_classifications.png")
